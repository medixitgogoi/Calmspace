...
const BoostChat = ({ navigation, route }) => {
    const {
        ...
        subscribeToMessages, unsubscribeFromMessages, connectSocket, socket
    } = useChatStore();
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
                ...
                >
                    ...
                    <View style={{
                        ...
                        paddingHorizontal: 5, justifyContent: 'space-between', marginBottom: 10,
                    }}>
                    ...
                    <View style={{
                        flexDirection: 'row', alignItems: 'center',
                        padding: 10, borderTopWidth: 1, borderColor: '#ccc',
                    }}>
                        <TextInput
                            value={message}
